...
export const kkLocale = {
	translations: {
		...
		[texts_v.login_page_title]: "Bonuts-қа кіру",
		[texts_v.login_page_subtitle]: "Сіздің командаңызға арналған алғыс жүйесі",
		[texts_v.login_with_vk]: "VK арқылы кіру",
		[texts_v.login_with_vk_loading]: "VK қосылуда…",
		[texts_v.or]: "немесе",
