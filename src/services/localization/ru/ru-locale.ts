...
export const ruLocale = {
	translations: {
		...
		[texts_v.login_page_title]: "Вход в Bonuts",
		[texts_v.login_page_subtitle]: "Система благодарностей для вашей команды",
		[texts_v.login_with_vk]: "Войти через VK",
		[texts_v.login_with_vk_loading]: "Подключаем VK…",
		[texts_v.or]: "или",
