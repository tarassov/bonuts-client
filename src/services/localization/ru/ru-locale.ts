...
export const ruLocale = {
	translations: {
		...
		[texts_n.new_team_member]: "Новый супергерой",
		...
		[texts_e.email]: "Email",
		[texts_l.language]: "Язык",
		[texts_m.moderator]: "Модератор",
		[texts_p.profile_tabs]: "Вкладки профиля",
		[texts_c.connect_to_telegram]: "Подключить Telegram",
		[texts_g.generate_code]: "Сгенерировать код",
		[texts_l.loading]: "Загрузка…",
		[texts_n.no_integrations_available]: "Нет доступных интеграций",
		[texts_n.not_connected]: "Не подключено",
		[texts_t.telegram_code]: "Код Telegram",
		[texts_a.and_other_important_information]: "И другая важная информация",
		[texts_a.anything_you_want_to_share]: "Всё, чем хочется поделиться",
		[texts_s.some_interesting_facts]: "Несколько интересных фактов о себе",
		...
		[texts_c.coming_soon]: "Скоро",
		[texts_c.copy_invitation_link]: "Скопировать ссылку приглашения",
		[texts_c.create_team_coming_soon_description]: "Скоро вы сможете создать команду и пригласить коллег отмечать вклад друг друга.",
		...
		[texts_d.delete_account]: "Удалить аккаунт",
		[texts_d.delete_account_coming_soon_description]: "Удаление аккаунта появится позже. Пока ваш аккаунт и приглашения остаются без изменений.",
		...
		[texts_j.join_team_with_work_email]: "Ваш рабочий email совпадает с доменом команды — можно присоединиться без приглашения.",
		...
		[texts_t.teams_matching_your_work_email]: "Команды, которые совпадают с вашим рабочим email и доступны для прямого присоединения.",
		...
		// D
		[texts_d.date_of_birth]: "Дата рождения",
		...
		// E
		Edit: "Редактировать",
		[texts_e.employment_date]: "Дата приёма",
		...
		[texts_m.main_information]: "Основная информация",
		[texts_n.name_surname_and_position]: "Имя, фамилия и должность",
		[texts_c.contacts]: "Контакты",
		[texts_e.email_and_direct_contact]: "Email и контакт для связи",
		[texts_a.additional_information]: "Дополнительно",
		...
		[texts_p.passwords_do_not_match]: "Пароли не совпадают",
		...
		[texts_r.recover_password_description]: "Укажите почту, и мы отправим ссылку для восстановления пароля.",
		...
		[texts_s.set_password_description]: "Придумайте новый пароль для своей учётной записи.",
		Share: "Поделиться",
		share: "поделиться",
		...
		[texts_s.sign_up_description]: "Создайте аккаунт и начните замечать вклад коллег.",
		...
		[texts_s.store_admin]: "Администратор магазина",
		...
		yes: "да",
		[texts_b.by_name]: "По имени",
		[texts_c.coin]: "Монета",
		[texts_c.create_your_team]: "Создайте команду",
		[texts_d.disabled]: "Отключено",
		[texts_d.donut]: "Пончик",
		[texts_i.no_invitations_received_yet]: "Приглашений пока нет",
		[texts_o.ok]: "ОК",
		[texts_o.operation]: "Операция",
		[texts_p.page_not_found]: "Страница не найдена",
		[texts_a.add_to_favorites]: "Добавить в избранное",
		[texts_s.submit]: "Подтвердить",
		// Z
		...timezonesRu,
		...weekdaysRu,
