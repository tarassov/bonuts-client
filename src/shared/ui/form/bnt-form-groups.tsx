...
import type { TFieldGroup, TFormField, TFormProps } from "./types/bnt-form";
...
> = ({ fields, formId, hasInitial, groups, groupGap }) => {
	return (
		<Grid container gap={groupGap}>
			{groups.map((group) => {
				const { className, content, description, headerContent, xs, sm, lg, md, gap, id, offset, padding, sx, title, ...rest } = group;
