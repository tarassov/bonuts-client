...
export function useStorage<TConfig extends TBasicStorageConfig, TKey extends Extract<keyof TConfig, string>>(name: TKey, initialValue: TConfig[TKey]) {
